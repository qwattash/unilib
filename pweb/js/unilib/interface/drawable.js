...
//-------------------- IDrawableProvider Interface ---------------------------
	unilib.interfaces.graphics.IDrawableProvider = function(){ };
	
	/**
	 * getter for id
	 * @returns {number | string}
	 */
	unilib.interfaces.graphics.IDrawableProvider.prototype.getID = function() {
	 ...
	 */
	unilib.interfaces.graphics.IDrawableProvider.prototype.setID = 
		function(id) {
			throw new unilib.error.AbstractMethodError();
	};
	 ...
	 */
	unilib.interfaces.graphics.IDrawableProvider.prototype.getShape = 
		function() {
			throw new unilib.error.AbstractMethodError();
	};
	 ...
	 * setter for shape
	 * @abstract
	 * @param {unilib.interfaces.graphics.IDrawable} shape
	 */
	unilib.interfaces.graphics.IDrawableProvider.prototype.setShape = 
		function(shape) {
			throw new unilib.error.AbstractMethodError();
	};
	 ...
	 * @param {unilib.graphics.IElementGroup} [group]
	...
	//events
	/**
	 * add event listener for the group, event types are the same as DOM ones 
	 * @abstract
	 * @param {string} eventType
	 * @param {function} listener
	 */
	unilib.interfaces.graphics.IRenderer.prototype.addEventListener = 
		function(eventType, listener) {
			throw new unilib.error.AbstractMethodError();
	};
	
	/**
	 * remove event listener for the group, event types are the same as DOM ones 
	 * @abstract
	 * @param {string} eventType
	 * @param {function} listener
	 */
	unilib.interfaces.graphics.IRenderer.prototype.removeEventListener = 
		function(eventType, listener) {
			throw new unilib.error.AbstractMethodError();
	};
